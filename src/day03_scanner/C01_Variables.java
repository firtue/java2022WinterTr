...
public class C01_Variables
{
    public static void main(String[] args) {
        ...
        short sayi7=20;
        double sayi8=30; // double virgüllü sayıdır yani şuan sayımız 30.0

        System.out.println("iki sayının toplamı "+ (sayi7+sayi8));
        // matematiksel işlemler için şimdilik parantez kullanalım

        System.out.println(sayi7+sayi8);
        // sadece matematiksel işlem varsa paranteze gerek kalmaz

        int deneme='a';
        System.out.println(deneme); //97
    }
